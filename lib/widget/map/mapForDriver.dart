...
class mapForDriver extends StatefulWidget {
  const mapForDriver({Key? key}) : super(key: key);

  @override
  _MapScreenState createState() => _MapScreenState();
}

class _MapScreenState extends State<mapForDriver> {
  ...
  Future<void> getAddressFromCoordinates(
    ...
    if(context.read<Repository>().fromCityDriver == null) {
      context.read<Repository>().setFromCityDriver(first.locality);
    }
    else{
      context.read<Repository>().setToCityDriver(first.locality);
    }
